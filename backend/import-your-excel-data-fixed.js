...
async function importYourExcelDataFixed() {
  try {
    console.log('🚀 Starting corrected import of your Excel files...');
    ...
    try {
      ...
      const medicalResult = await importFileFixed(db, '/Users/kashyapanand/Desktop/DBcopy/processed_files_recursive/medical.xlsx', 'MEDICAL', importStats);
      
      // Import Dental Colleges
      console.log('\n🦷 Importing Dental Colleges...');
      const dentalResult = await importFileFixed(db, '/Users/kashyapanand/Desktop/DBcopy/processed_files_recursive/dental.xlsx', 'DENTAL', importStats);
      
      // Import DNB Colleges
      console.log('\n🏥 Importing DNB Colleges...');
      const dnbResult = await importFileFixed(db, '/Users/kashyapanand/Desktop/DBcopy/processed_files_recursive/dnb.xlsx', 'DNB', importStats);
...
async function importFileFixed(db, filePath, collegeType, importStats) {
  try {
    ...
    // Process each row and group by college
...
if (require.main === module) {
  importYourExcelDataFixed();
}

module.exports = { importYourExcelDataFixed };
