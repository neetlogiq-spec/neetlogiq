...
/**
 * Import Clean College Data from SQLite to Cloudflare D1 (Simple Version)
 * This script imports data without ID conflicts
 */
...
async function importCleanData() {
  try {
    ...
    // Export to CSV with proper formatting (excluding ID to avoid conflicts)
